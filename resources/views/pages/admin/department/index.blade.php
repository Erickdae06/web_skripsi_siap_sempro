...
@section('container')
    <main>
        <header class="page-header page-header-compact page-header-dark bg-dark mb-4 border-bottom border-3 border-success">
        ...
        <div class="container-xl px-4 mt-4">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-header-actions mb-4 border-3 border-success border">
                        <div class="card-header bg-dark bg-gradient text-success border-bottom border-2 border-success">
                            List Departemen
    ...
    <div class="modal fade" id="createModal" role="dialog" aria-labelledby="createModal" aria-hidden="true" style="overflow:hidden;">
        <div class="modal-dialog" role="document">
            <div class="modal-content bg-dark border-3 border-success text-light">
                <div class="modal-header">
                    <h5 class="modal-title text-light" id="createModal">Tambah Data Departemen</h5>
                ...
                <form action="{{ route('department.store') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-outline-danger text-light" type="button" data-bs-dismiss="modal">Batal</button>
