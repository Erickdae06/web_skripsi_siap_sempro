...
@section('container')
    <main>
        ...
        <div class="container-xl px-4 mt-4 bg none">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-header-actions mb-4 border-success border border-3">
                        <div class="card-header border-success border-bottom border-2 bg-dark bg-gradient text-success">
                            List Surat Masuk
